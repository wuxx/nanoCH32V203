...
extern volatile UINT16 USBHD_Endp1_Up_Flag;                                     /* USB2.0全速设备端点1数据上传状态: 0:空闲; 1:正在上传; */
extern volatile UINT8  USBHD_Endp1_Down_Flag;                                   /* USB2.0全速设备端点1下传成功标志 */
extern volatile UINT8  USBHD_Endp1_Down_Len;                                    /* USB2.0全速设备端点1下传长度 */
extern volatile BOOL   USBHD_Endp1_T_Tog;                                       /* USB2.0全速设备端点1发送tog位翻转 */
extern volatile BOOL   USBHD_Endp1_R_Tog;

extern volatile UINT16 USBHD_Endp2_Up_Flag;                                     /* USB2.0全速设备端点2数据上传状态: 0:空闲; 1:正在上传; */
extern volatile UINT16 USBHD_Endp2_Up_LoadPtr;                                  /* USB2.0全速设备端点2数据上传装载偏移 */
extern volatile UINT8  USBHD_Endp2_Down_Flag;                                   /* USB2.0全速设备端点2下传成功标志 */
extern volatile BOOL   USBHD_Endp2_T_Tog;                                       /* USB2.0全速设备端点1发送tog位翻转 */
extern volatile BOOL   USBHD_Endp2_R_Tog;
...
extern void USBHD_Init( void );

extern void Ep1_Tx( PUINT8 data, UINT8 len );
extern void Ep2_Tx( PUINT8 data, UINT8 len );
