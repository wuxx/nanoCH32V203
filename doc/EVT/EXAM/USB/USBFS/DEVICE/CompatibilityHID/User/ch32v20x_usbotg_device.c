...
#define DEF_ENDP_SIZE_L        (UINT8)(DEF_USBD_MAX_PACK_SIZE&0xFF)
#define DEF_ENDP_SIZE_H        (UINT8)(DEF_USBD_MAX_PACK_SIZE>>8)
/* 端点大小定义 */
...
UINT8  MyCfgDescr[ ] =
{
    ...
    0x07,0x05,0x81,0x03,DEF_ENDP_SIZE_L,DEF_ENDP_SIZE_H,0x01,    //端点描述符(全速间隔时间改成1ms)
    0x07,0x05,0x01,0x03,DEF_ENDP_SIZE_L,DEF_ENDP_SIZE_H,0x01,    //端点描述符
};
...
/* USB全速模式,其他速度配置描述符 */
UINT8 TAB_USB_FS_OSC_DESC[sizeof(MyCfgDescr)] =
{
    0x09, 0x07,                                                                 /* ��������ͨ�������� */
};
                        ...
                        case USB_GET_DESCRIPTOR:
                        {
                            switch( ((pSetupReqPakHD->wValue)>>8) )
                            {
                                ...
                                case USB_DESCR_TYP_SPEED:
                                    ...
                                    {
                                      /* 全速模式 */
                                      memcpy( &TAB_USB_FS_OSC_DESC[ 2 ], &MyCfgDescr[ 2 ], sizeof( MyCfgDescr ) - 2 );
