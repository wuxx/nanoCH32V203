/********************************** (C) COPYRIGHT *******************************
 * File Name          : ch32v20x_usbotg_host.h
 * Author             : WCH
 * Version            : V1.0.0
 * Date               : 2021/06/06
 ...
 *******************************************************************************/
#ifndef __CH32V20x_USBOTG_HOST_H__
#define __CH32V20x_USBOTG_HOST_H__
#include "debug.h"
#include "string.h"
...
extern UINT8 DeviceDescriptor[ ];
extern UINT8 ConfigDescriptor[ ];
extern __attribute__ ((aligned(4))) const UINT8  HIDSetReport[ ];
extern __attribute__ ((aligned(4))) const UINT8  HIDGetReport[ ];
/*******************��������*******************/
