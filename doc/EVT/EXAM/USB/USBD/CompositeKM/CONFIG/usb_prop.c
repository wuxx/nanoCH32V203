...
extern uint8_t Endp1Busy,Endp2Busy;
...
{
	{(uint8_t*)USBD_KeyRepDesc, USBD_SIZE_KEYBOARD_DESC},
...
/*********************************************************************
 * @fn      USBD_HID_Mouse_Updata.
 *
 * @brief   HID Mouse Updata
 *
 * @param   
 *
 * @return  none
 */
__attribute__((optimize("O0"))) void USBD_HID_Mouse_Updata(void)
{
  while (Endp2Busy);
  UserToPMABufferCopy(HIDMouse, ENDP2_TXADDR, ENDP2_IN_SIZE);
...
/*********************************************************************
 * @fn      USBD_HID_Keyboard_Updata.
 *
 * @brief   HID Keyboard Updata
 *
 * @param   
 *
 * @return  none
 */
__attribute__((optimize("O0"))) void USBD_HID_Keyboard_Updata(void)
{
  while (Endp1Busy);
