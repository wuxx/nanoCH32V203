...
#define USBD_SIZE_CONFIG_DESC        0x3b
...
extern const uint8_t USBD_KeyRepDesc[USBD_SIZE_KEYBOARD_DESC];
extern const uint8_t USBD_MouseRepDesc[USBD_SIZE_MOUSE_DESC];
